...
SELECT i.id, i.workspace_id, i.title, i.description, i.status, i.priority,
       ...
       i.parent_issue_id, i.position, i.start_date, i.due_date, i.created_at, i.updated_at, i.number, i.project_id, i.metadata, i.stage, i.properties, i.orchestration_mode, i.fdl_run_id
FROM issue i
